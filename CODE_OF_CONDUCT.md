...
- Being respectful of differing viewpoints and experiences — this project
  touches production infrastructure, and reasonable people can disagree on
  operational trade-offs
- Giving and gracefully accepting constructive feedback, especially on
  correctness and safety of changes to a script that runs against live
  systems
- Focusing on what is best for the community of admins who rely on this
  tool
